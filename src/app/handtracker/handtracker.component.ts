  ...
  runDetection(){
    if (this.model != null){
        let predictions = this.model.detect(this.video.nativeElement).then((predictions: any) => {
            ...
            else if(openhands == 1 && closedhands == 0) this.detectedGesture = "Open Hand";
            else if (openhands == 1 && closedhands == 1) this.detectedGesture = "One Open One Closed";
            
            if (closedhands > 1) this.detectedGesture = "Two Closed Hands";
            else if(closedhands == 1 && openhands == 0) this.detectedGesture = "Closed Hand";
            
            if (pointing > 1) this.detectedGesture = "Two Hands Pointing";
            else if(pointing == 1 && openhands == 0 && closedhands == 0) this.detectedGesture = "Hand Pointing";
            else if (pointing == 1 && closedhands == 1) this.detectedGesture = "One Pointing One Closed";
            else if (pointing == 1 && openhands == 1) this.detectedGesture = "One Pointing One Open"
